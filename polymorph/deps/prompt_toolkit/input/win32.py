...
from polymorph.deps.prompt_toolkit.eventloop.win32 import wait_for_handles
...
from polymorph.deps.prompt_toolkit.win32_types import EventTypes, KEY_EVENT_RECORD, MOUSE_EVENT_RECORD, INPUT_RECORD, STD_INPUT_HANDLE
