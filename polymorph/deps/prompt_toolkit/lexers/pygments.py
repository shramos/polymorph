...
from polymorph.deps.prompt_toolkit.formatted_text.utils import split_lines
from polymorph.deps.prompt_toolkit.styles.pygments import pygments_token_to_classname
...
class PygmentsLexer(Lexer):
    ...
    Note: Don't forget to also load a Pygments compatible style. E.g.::
        ...
        from polymorph.deps.prompt_toolkit.styles.from_pygments import style_from_pygments_cls
