...
from polymorph.deps.prompt_toolkit.cache import memoized
...
def has_focus(value):
    ...
    from polymorph.deps.prompt_toolkit.layout.controls import UIControl
    from polymorph.deps.prompt_toolkit.layout.containers import to_container, Window
    from polymorph.deps.prompt_toolkit.layout import walk
