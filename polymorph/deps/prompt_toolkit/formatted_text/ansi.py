...
from polymorph.deps.prompt_toolkit.output.vt100 import FG_ANSI_COLORS, BG_ANSI_COLORS
from polymorph.deps.prompt_toolkit.output.vt100 import _256_colors as _256_colors_table
