...
from polymorph.deps.prompt_toolkit.formatted_text.utils import split_lines, fragment_list_to_text
from polymorph.deps.prompt_toolkit.lexers import Lexer, SimpleLexer
...
class FormattedTextControl(UIControl):
    ...
    def __init__(self, text='', style='', focusable=False, key_bindings=None,
        ...
        from polymorph.deps.prompt_toolkit.key_binding.key_bindings import KeyBindingsBase
